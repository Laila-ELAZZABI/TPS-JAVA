...
public class TestSet {
    public static void main(String[] args) {
        ...
        set2.add(new Client(1,"MOSSAB"));
        set2.add(new Client(1,"LAILA"));
        set2.add(new Client(2,"OUSSAMA"));
        ...
        set4.add(new Client(1,"GHITA"));
        set4.add(new Client(3,"BAHAFID"));
        set4.add(new Client(2,"SALMA"));
